...
** Wanna Albums
  ...
  <ul id="wannaAlbumList" class="list-group">
    <a target="_blank" href="https://www.youtube.com/playlist?list=PLCKp_J1GOMgB6ET77QRqfcZMU0iBJrmHf"                                  class="list-group-item list-group-item-action wannaAlbum"><p style="display:inline;background-color:blue;">£11.49 | A quiet place to die - Alpha wolf</p></a>
    ...
    <a target="_blank" href="https://eu.kingsroadmerch.com/metal-blade/artist/1330"                                                     class="list-group-item list-group-item-action wannaAlbum"><p style="display:inline;background-color:blue;">€14    | Datalysium - The Zenit Passage</p></a>
