...
#+TITLE: Scala Example: TestContainers With DockerComposeContainer And MUnit
#+DESCRIPTION: Scala Example: TestContainers With DockerComposeContainer and MUnit
...
* Scala Example: TestContainers With DockerComposeContainer and MUnit
  :PROPERTIES:
  :CUSTOM_ID: Article
  :END:
...
#+html: <script src="https://emgithub.com/embed.js?target=https%3A%2F%2Fgithub.com%2Fbenkio%2FmyTelegramBot%2Fblob%2Fb2fb9d26cb9b9dbc9660374ed90a805e02f5df3e%2FbotDB%2Fsrc%2Fit%2Fscala%2Fcom%2Fbenkio%2FbotDB%2FContainerSuite.scala&style=github&showBorder=on&showCopy=on"></script>
