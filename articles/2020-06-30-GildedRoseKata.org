...
*** Haskell Kata
    ...
    <2020-07-14 Tue>: Haskell test completed. [[https://github.com/benkio/GeneralExercises/commit/f19fa11][commit]]

    <2020-07-15 Wed>: Haskell started to split the monster. Added
    Hlint, you can't immagine how many /redundant bracket/ I removed. [[https://github.com/benkio/GeneralExercises/commit/acce770][commit]]
** Conclusions
   :PROPERTIES:
...
*** Languages Comparison
    ...
    away. Even if it doesn't seems very important, this is a big
...
Perhaps:
  if (sellIn < 6) && (quality < 48) then 1 else 0
    ...
    *[[https://github.com/ndmitchell/hlint][hlint]] is cheating in this exercise* and it works only because
    ...
    tools, like [[https://github.com/scalacenter/scalafix][scalafix]], but it slipped out from my mind. With it, I
