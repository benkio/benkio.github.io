...
* Advent Of Code 2024
  ...
  :END:
  *Created: <2025-01-17 Fri>*
** Abstract
  :PROPERTIES:
  :CUSTOM_ID: ArticleAbstract
  :END:

  This time I was quicker then last year definitely and it was
  simpler. I don't think I'm becoming a better programmer, but rather
  the site dimished the difficulty. At least I didn't have to struggle
  much 😎

  You can find all the code in here: [[https://github.com/benkio/AdventOfCode][Advent Of Code
  Repository]]
...
#+BEGIN_EXPORT html
<figure>
  <img src="./2025-01-17-AdventOfCode2024/AdventOfCodeCompleted.png" alt="Completed Screen of Advent of Code" align="left" title="Advent Of Code Completed" class="img-fluid" style="width:100%;"/>
...
<div class="embed-responsive embed-responsive-16by9">
  <video controls autoplay loop>
    <source src="./2025-01-17-AdventOfCode2024/AdventOfCodeCalendar.mp4" type="video/mp4">
  </video>
</div>
...
** Conclusions
  ...
  This time I initiated a ~Lib~ with common algorithm that might be
  useful for next years 🤞
