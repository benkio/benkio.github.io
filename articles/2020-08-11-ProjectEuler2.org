...
*** Largest Product in a Grid
    ...
    Solution:
    #+html: <script src="https://gist-it.appspot.com/https://github.com/benkio/GeneralExercises/blob/master/ProjectEuler/projectEuler2.hs?slice=10:77"></script>
...
*** Highly Divisible Triangular Number
    ...
    Solution:
    #+html: <script src="https://gist-it.appspot.com/https://github.com/benkio/GeneralExercises/blob/master/ProjectEuler/projectEuler2.hs?slice=77:93"></script>
...
*** Large Sum
    ...
    Solution:
    #+html: <script src="https://gist-it.appspot.com/https://github.com/benkio/GeneralExercises/blob/master/ProjectEuler/projectEuler2.hs?slice=94:201"></script>
...
*** Largest Collatz Sequesnce
    ...
    Note: this hangs and never returns, any suggestion on how to improve this solution is welcome.
