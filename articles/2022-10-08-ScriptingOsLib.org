...
*** FFMPEG Command
  ...
  One could wonder why I didn't go for [[https://javadoc.io/doc/com.lihaoyi/os-lib_3/latest/api/os/proc.html][os.spawn]] instead of [[https://javadoc.io/doc/com.lihaoyi/os-lib_3/latest/api/os/proc.html][os.call]] in
...
# change the entry point to be parallel?? is it convenient? the whole
# system could collapse, maybe restrict to 2 processes in parallel.
# link the discussion about parallelism in ffmpeg command section
** Conclusions
  :PROPERTIES:
  :CUSTOM_ID: ArticleConclusions
  :END:
** References
# link to the final gist
* Share Buttons
  :PROPERTIES:
