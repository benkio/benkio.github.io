...
INFO[2025-09-26T12:32:09.286214647+01:00] skip loading plugin "io.containerd.snapshotter.v1.aufs"...  error="aufs is not supported (modprobe aufs failed: exit status 1 \"modprobe: FATAL: Module aufs not found in directory /lib/modules/6.8.0-83-generic\\n\"): skip plugin" type=io.containerd.snapshotter.v1
