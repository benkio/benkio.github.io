...
** Abstract
  ...
  extract data from YouTube using the [[https://github.com/yt-dlp/yt-dlp][yt-dlp]] and [[https://jqlang.github.io/jq/][jq]].
...
*** Get Data from YouTube
  ...
  This puts a size of a sigle video ~0.5MB. [[https://github.com/yt-dlp/yt-dlp][yt-dlp]] takes quite some
...
*** Extract Data from the JSON
  ...
  the [[https://jqlang.github.io/jq/][jq]] commnd and do another tutorial, but rather I'll explain what
