...
#+begin_export html
<figure>
<div class="ratio ratio-4x3"><iframe class="responsive-iframe" src="https://www.youtube.com/embed/mT1lF6Efi1E?rel=0" allowfullscreen></iframe></div>
<figcaption>
...
*** Situation, Motivation & First Impact
  ...
  Then, I bought a cheap [[https://uk.jacksonguitars.com/products/js-series-dinky-arch-top-js22-7-dka-ht][7-string guitar]] (because I never had one, so
  why not), a ~100$ 2016 M-Track 2x2~, a small [[https://www.blackstaramps.com/uk/products/fly-3][Blackstar mini
...
**** Technical Difficulties
    ...
    :END:
     ...
     Positive Grid provides a specific ASIO driver for the Spark amp,
     ...
     fact, going to the driver page right now I see /Updated:
...
***** Glassy
     ...
     #+begin_export html
     <figure>
<div class="ratio ratio-4x3">     <iframe class="responsive-iframe" src="https://www.youtube.com/embed/UVepVNuitvw" allowfullscreen></iframe></div>
     <figcaption>
     Lick Friday 247
     </figcaption>
     </figure>
     ...
     <figure>
<div class="ratio ratio-4x3">     <iframe class="responsive-iframe" src="https://www.youtube.com/embed/cuhAXtjgTos" allowfullscreen></iframe></div>
     <figcaption>
     Lick Friday 250
     </figcaption>
     </figure>
