...
*** <2025-12-02 Tue> - Edit
  ...
  As I added it into my [[https://github.com/benkio/nix-config/blob/a860ea55ee4fee0bad8b5c2c7b8baf8b074fa164/homeCommon/programs/bash.nix#L14-L24][update alias]] and it runs every time I update all the system I want it to be more performant.
...
In my case, I added it to [[https://github.com/benkio/nix-config/blob/78454ac059053844fceb2191cf4c0bc122cacc4e/homeCommon/gists.nix][my nix configuration]]. That's a way to be
