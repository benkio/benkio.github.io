...
#+TITLE: Effect TS Introduction
#+DESCRIPTION: Effect TS Introduction
#+KEYWORDS: Effect TS Introduction
...
** Abstract
  ...
  Presentation about [[https://effect.website/][Effect-TS]] library
...
[[file:2026-03-18-EffectTSIntro/EffectTS.html]]
...
** Conclusions
  ...
  I hope it can be useful if someone needs to onboard someone else to the library.
