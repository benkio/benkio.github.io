...
** Abstract
  ...
  The addition of this edition are **TESTS**!!!
  Plus we have only 12 days. WAAAAY BETTER
...
#+BEGIN_EXPORT html
<figure>
  <img src="./2025-12-24-AdventOfCode2025/AdventOfCodeCompleted.png" alt="Completed Screen of Advent of Code" align="left" title="Advent Of Code Completed" class="img-fluid" style="width:100%;"/>
...
<div class="embed-responsive embed-responsive-16by9">
  <video controls autoplay loop>
    <source src="./2025-12-24-AdventOfCode2025/AdventOfCodeCalendar.mp4" type="video/mp4">
  </video>
</div>
...
** Conclusions
  ...
  Still need to improve past years and lib, but we will keep going
