...
<div class="col-10 m-auto text-center">
  <input type="text" class="form-control my-2" id="elementSearch" onkeyup="elementSearch('article', false)" placeholder="Search for Article..." title="Type in a Book Title" style="height: 4em;">
...
#+begin_src javascript :exports none
    ...
    const htmlArticlesTitle = articlesZip.map(function(tuple) {
        ...
        return $('<a href="' + articlePath + '" class="w-100 w-md-75 m-auto list-group-item list-group-item-action article">' + articleTitle + '</a>');
    });
