...
#+BEGIN_EXPORT HTML
<div class="row row-cols-1 row-cols-sm-3 my-2 w-100 g-2">
  <div class="col text-center"> <button type="button" class="btn btn-lg btn-danger wantedBook w-100"  >Digital Only<br> Don't Buy</button></div>
...
<p class="text-center">Price source: Bandcamp, Amazon, and Discogs. Price reference with shipment to UK.</p>
#+END_EXPORT
