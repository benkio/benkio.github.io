...
**Created:** <2020-06-21 Sun>
  ...
  <div class="col-10 text-center">
    <input type="text" class="form-control my-2" id="elementSearch" onkeyup="elementSearch('album')" placeholder="Search for album..." title="Type in an album Title" style="text-align: center; width: 80%;margin-left: auto;margin-right: auto; display: block;">
