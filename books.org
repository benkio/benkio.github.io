...
* Books
  ...
  **Created:** <2020-06-21 Sun>
  ...
  <div class="col-10 m-auto">
    <input type="text" class="form-control" id="elementSearch" onkeyup="elementSearch('books')" placeholder="Search for Book..." title="Type in a Book Title" style="height: 4em;">
  </div>
...
:HTML_HEADLINE_CLASS: mx-auto my-3 col-10 text-center
:END:
...
document.getElementById("text-Books").classList.add("m-auto", "col-10");
document.getElementById("text-WannaBooks").classList.add("m-auto","col-10");
</script>
#+end_export
