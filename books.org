...
* Books
  ...
  **Created:** <2020-06-21 Sun>
  ...
  <div class="col-md-10 m-auto">
    <input type="text" class="form-control my-2" id="elementSearch" onkeyup="elementSearch('book', true)" placeholder="Search for Book..." title="Type in a Book Title" style="height: 4em;">
  </div>
...
:END:
  ...
  #+BEGIN_EXPORT HTML
  <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 my-2 w-100 g-2">
    <div class="col text-center"> <button type="button" class="btn btn-lg btn-danger wantedBook w-100"  >Available Online <br> Don't Buy</button></div>
    <div class="col text-center"> <button type="button" class="btn btn-lg btn-success wantedBook w-100" >Readable Online <br> Don't Buy</button></div>
    <div class="col text-center"> <button type="button" class="btn btn-lg btn-primary wantedBook w-100" >Purchased <br> Don't Buy</button></div>
    <div class="col text-center"> <button type="button" class="btn btn-lg btn-dark wantedBook w-100" >You Can Buy/Gift This😛</button></div>
  </div>
  <hr>
  #+END_EXPORT
